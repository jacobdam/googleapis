...
checkUnnamed1742(core.List<api.PublicKey> o) {
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1744();
    o.name = "foo";
    o.response = buildUnnamed1745();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1744(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1745(o.response);
  }
  buildCounterOperation--;
}
