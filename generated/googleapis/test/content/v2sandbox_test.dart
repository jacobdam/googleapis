...
checkUnnamed3715(core.List<api.Error> o) {
...
checkUnnamed3716(core.List<api.OrderLineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3717(core.List<api.OrderPromotion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3718(core.List<api.OrderRefund> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3719(core.List<api.OrderShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrder() {
  ...
  if (buildCounterOrder < 3) {
    ...
    o.paymentStatus = "foo";
    o.placedDate = "foo";
    o.promotions = buildUnnamed3717();
    o.refunds = buildUnnamed3718();
    o.shipments = buildUnnamed3719();
...
checkOrder(api.Order o) {
  ...
  if (buildCounterOrder < 3) {
    ...
    checkUnnamed3717(o.promotions);
    checkUnnamed3718(o.refunds);
    checkUnnamed3719(o.shipments);
...
buildOrderAddress() {
  ...
  if (buildCounterOrderAddress < 3) {
    o.country = "foo";
    o.fullAddress = buildUnnamed3720();
    o.isPostOfficeBox = true;
    o.locality = "foo";
    o.postalCode = "foo";
    o.recipientName = "foo";
    o.region = "foo";
    o.streetAddress = buildUnnamed3721();
  }
  buildCounterOrderAddress--;
  return o;
}
...
checkOrderAddress(api.OrderAddress o) {
  ...
  if (buildCounterOrderAddress < 3) {
    ...
    checkUnnamed3720(o.fullAddress);
    ...
    checkUnnamed3721(o.streetAddress);
  }
  buildCounterOrderAddress--;
}
...
checkUnnamed3722(core.List<api.OrderMerchantProvidedAnnotation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3723(core.List<api.OrderCancellation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3724(core.List<api.OrderReturn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrderLineItem() {
  ...
  if (buildCounterOrderLineItem < 3) {
    o.annotations = buildUnnamed3722();
    o.cancellations = buildUnnamed3723();
    o.id = "foo";
    o.price = buildPrice();
...
checkOrderLineItem(api.OrderLineItem o) {
  buildCounterOrderLineItem++;
  if (buildCounterOrderLineItem < 3) {
    checkUnnamed3722(o.annotations);
    checkUnnamed3723(o.cancellations);
    unittest.expect(o.id, unittest.equals('foo'));
    checkPrice(o.price);
...
checkUnnamed3725(core.List<api.OrderLineItemProductVariantAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrderLineItemProduct() {
  ...
  if (buildCounterOrderLineItemProduct < 3) {
    ...
    o.targetCountry = "foo";
    o.title = "foo";
    o.variantAttributes = buildUnnamed3725();
  }
  buildCounterOrderLineItemProduct--;
  return o;
}
...
checkOrderLineItemProduct(api.OrderLineItemProduct o) {
  ...
  if (buildCounterOrderLineItemProduct < 3) {
    ...
    checkUnnamed3725(o.variantAttributes);
  }
  buildCounterOrderLineItemProduct--;
}
...
checkUnnamed3726(core.List<api.OrderPromotionBenefit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3728(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3729(core.List<api.OrdersCustomBatchRequestEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3730(core.List<api.OrderMerchantProvidedAnnotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderMerchantProvidedAnnotation(o[0]);
  checkOrderMerchantProvidedAnnotation(o[1]);
}
...
checkUnnamed3731(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderShipmentLineItemShipment(o[0]);
  checkOrderShipmentLineItemShipment(o[1]);
}
...
buildOrdersCustomBatchRequestEntryShipLineItems() {
  ...
  if (buildCounterOrdersCustomBatchRequestEntryShipLineItems < 3) {
    o.carrier = "foo";
    o.lineItems = buildUnnamed3731();
    o.shipmentId = "foo";
    o.shipmentInfos = buildUnnamed3732();
    o.trackingId = "foo";
  }
  buildCounterOrdersCustomBatchRequestEntryShipLineItems--;
  return o;
...
checkOrdersCustomBatchRequestEntryShipLineItems(
  ...
  if (buildCounterOrdersCustomBatchRequestEntryShipLineItems < 3) {
    unittest.expect(o.carrier, unittest.equals('foo'));
    checkUnnamed3731(o.lineItems);
    unittest.expect(o.shipmentId, unittest.equals('foo'));
    checkUnnamed3732(o.shipmentInfos);
    unittest.expect(o.trackingId, unittest.equals('foo'));
  }
  buildCounterOrdersCustomBatchRequestEntryShipLineItems--;
}
...
checkUnnamed3733(core.List<api.OrdersCustomBatchResponseEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3734(core.List<api.Order> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrder(o[0]);
  checkOrder(o[1]);
}
...
checkUnnamed3735(core.List<api.OrderMerchantProvidedAnnotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderMerchantProvidedAnnotation(o[0]);
  checkOrderMerchantProvidedAnnotation(o[1]);
}
...
buildOrdersSetLineItemMetadataRequest() {
  ...
  if (buildCounterOrdersSetLineItemMetadataRequest < 3) {
    o.annotations = buildUnnamed3735();
    o.lineItemId = "foo";
    o.operationId = "foo";
    o.productId = "foo";
  }
...
checkOrdersSetLineItemMetadataRequest(api.OrdersSetLineItemMetadataRequest o) {
  buildCounterOrdersSetLineItemMetadataRequest++;
  if (buildCounterOrdersSetLineItemMetadataRequest < 3) {
    checkUnnamed3735(o.annotations);
    unittest.expect(o.lineItemId, unittest.equals('foo'));
    unittest.expect(o.operationId, unittest.equals('foo'));
    unittest.expect(o.productId, unittest.equals('foo'));
  }
...
checkUnnamed3736(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderShipmentLineItemShipment(o[0]);
  checkOrderShipmentLineItemShipment(o[1]);
}
...
buildOrdersShipLineItemsRequest() {
  ...
  if (buildCounterOrdersShipLineItemsRequest < 3) {
    o.carrier = "foo";
    o.lineItems = buildUnnamed3736();
    o.operationId = "foo";
    o.shipmentId = "foo";
    o.shipmentInfos = buildUnnamed3737();
    o.trackingId = "foo";
  }
  buildCounterOrdersShipLineItemsRequest--;
  return o;
...
checkOrdersShipLineItemsRequest(api.OrdersShipLineItemsRequest o) {
  ...
  if (buildCounterOrdersShipLineItemsRequest < 3) {
    unittest.expect(o.carrier, unittest.equals('foo'));
    checkUnnamed3736(o.lineItems);
    unittest.expect(o.operationId, unittest.equals('foo'));
    unittest.expect(o.shipmentId, unittest.equals('foo'));
    checkUnnamed3737(o.shipmentInfos);
    unittest.expect(o.trackingId, unittest.equals('foo'));
  }
  buildCounterOrdersShipLineItemsRequest--;
}
...
checkUnnamed3738(core.List<api.TestOrderLineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3739(core.List<api.OrderPromotion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderPromotion(o[0]);
  checkOrderPromotion(o[1]);
}
...
checkUnnamed3740(core.List<api.OrderLineItemProductVariantAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderLineItemProductVariantAttribute(o[0]);
  checkOrderLineItemProductVariantAttribute(o[1]);
}
...
buildTestOrderLineItemProduct() {
  ...
  if (buildCounterTestOrderLineItemProduct < 3) {
    ...
    o.targetCountry = "foo";
    o.title = "foo";
    o.variantAttributes = buildUnnamed3740();
  }
  buildCounterTestOrderLineItemProduct--;
  return o;
}
...
checkTestOrderLineItemProduct(api.TestOrderLineItemProduct o) {
  ...
  if (buildCounterTestOrderLineItemProduct < 3) {
    ...
    unittest.expect(o.targetCountry, unittest.equals('foo'));
    unittest.expect(o.title, unittest.equals('foo'));
    checkUnnamed3740(o.variantAttributes);
  }
  buildCounterTestOrderLineItemProduct--;
}
...
main() {
  ...
  unittest.group("resource-OrdersResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_statuses = buildUnnamed3741();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
