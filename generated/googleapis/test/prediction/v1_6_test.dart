...
checkUnnamed767(core.List<api.AnalyzeDataDescriptionFeatures> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed768(core.List<api.AnalyzeDataDescriptionOutputFeatureText> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed770() {
  ...
  o.add(buildUnnamed769());
  o.add(buildUnnamed769());
  return o;
}

checkUnnamed770(core.List<core.Map<core.String, core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed769(o[0]);
  checkUnnamed769(o[1]);
}
...
checkUnnamed772(core.Map<core.String, core.Map<core.String, core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed771(o["x"]);
  checkUnnamed771(o["y"]);
}
...
buildAnalyzeModelDescription() {
  ...
  if (buildCounterAnalyzeModelDescription < 3) {
    o.confusionMatrix = buildUnnamed772();
    o.confusionMatrixRowTotals = buildUnnamed773();
...
checkAnalyzeModelDescription(api.AnalyzeModelDescription o) {
  buildCounterAnalyzeModelDescription++;
  if (buildCounterAnalyzeModelDescription < 3) {
    checkUnnamed772(o.confusionMatrix);
    checkUnnamed773(o.confusionMatrixRowTotals);
...
checkUnnamed775(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed776(core.List<api.InsertTrainingInstances> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed777(core.Map<core.String, core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed778(core.List<core.Map<core.String, core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed777(o[0]);
  checkUnnamed777(o[1]);
}
...
buildInsert() {
  ...
  if (buildCounterInsert < 3) {
    ...
    o.trainingInstances = buildUnnamed776();
    o.utility = buildUnnamed778();
  }
  buildCounterInsert--;
  return o;
}
...
checkInsert(api.Insert o) {
  ...
  if (buildCounterInsert < 3) {
    ...
    checkUnnamed776(o.trainingInstances);
    checkUnnamed778(o.utility);
  }
  buildCounterInsert--;
}
...
checkUnnamed779(core.List<api.Insert2> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInsert2(o[0]);
  checkInsert2(o[1]);
}
...
checkUnnamed780(core.List<api.OutputOutputMulti> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed781(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
