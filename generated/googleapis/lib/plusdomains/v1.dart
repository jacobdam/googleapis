  ...
  Acl.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("items")) {
      items = _json["items"]
          ...
          .toList()
          .cast<PlusDomainsAclentryResource>();
    }
  ...
  ActivityObjectAttachments.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("previewThumbnails")) {
      previewThumbnails = _json["previewThumbnails"]
          ...
          .toList()
          .cast<ActivityObjectAttachmentsPreviewThumbnails>();
    }
    if (_json.containsKey("thumbnails")) {
      thumbnails = _json["thumbnails"]
          ...
          .toList()
          .cast<ActivityObjectAttachmentsThumbnails>();
    }
    if (_json.containsKey("url")) {
      url = _json["url"];
    }
  ...
  ActivityObject.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("attachments")) {
      attachments = _json["attachments"]
          ...
          .toList()
          .cast<ActivityObjectAttachments>();
    }
    if (_json.containsKey("content")) {
      content = _json["content"];
    }
...
class AudiencesFeed {
  ...
  AudiencesFeed.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("items")) {
      items = _json["items"]
          .map((value) => new Audience.fromJson(value))
          .toList()
          .cast<Audience>();
    }
    if (_json.containsKey("kind")) {
...
class CircleFeed {
  ...
  CircleFeed.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("items")) {
      items = _json["items"]
          .map((value) => new Circle.fromJson(value))
          .toList()
          .cast<Circle>();
    }
    if (_json.containsKey("kind")) {
...
class Person {
  ...
  Person.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("urls")) {
      urls = _json["urls"]
          .map((value) => new PersonUrls.fromJson(value))
          .toList()
          .cast<PersonUrls>();
    }
