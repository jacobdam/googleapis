...
checkUnnamed4136(core.Map<core.String, core.Object> o) {
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4136();
    o.name = "foo";
    o.response = buildUnnamed4137();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4136(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4137(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed4139(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed4139();
  }
  buildCounterSpeechRecognitionResult--;
  return o;
}
...
checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed4139(o.alternatives);
  }
  buildCounterSpeechRecognitionResult--;
}
...
checkUnnamed4142(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
