...
checkUnnamed4347(core.List<api.KeyRangeLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4348(core.List<api.StreamLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStreamLocation(o[0]);
  checkStreamLocation(o[1]);
}
...
checkUnnamed4349(core.List<api.StateFamilyConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildComputationTopology() {
  ...
  if (buildCounterComputationTopology < 3) {
    o.computationId = "foo";
    o.inputs = buildUnnamed4346();
    o.keyRanges = buildUnnamed4347();
    o.outputs = buildUnnamed4348();
    o.stateFamilies = buildUnnamed4349();
...
checkComputationTopology(api.ComputationTopology o) {
  ...
  if (buildCounterComputationTopology < 3) {
    ...
    checkUnnamed4346(o.inputs);
    checkUnnamed4347(o.keyRanges);
    checkUnnamed4348(o.outputs);
    checkUnnamed4349(o.stateFamilies);
...
checkUnnamed4355(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4357(core.List<api.WorkerPool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkerPool(o[0]);
  checkWorkerPool(o[1]);
}
...
buildEnvironment() {
  ...
  if (buildCounterEnvironment < 3) {
    ...
    o.dataset = "foo";
    o.experiments = buildUnnamed4352();
    o.internalExperiments = buildUnnamed4353();
    o.sdkPipelineOptions = buildUnnamed4354();
    o.serviceAccountEmail = "foo";
    o.tempStoragePrefix = "foo";
    o.userAgent = buildUnnamed4355();
    o.version = buildUnnamed4356();
    o.workerPools = buildUnnamed4357();
  }
  buildCounterEnvironment--;
  return o;
}
...
checkEnvironment(api.Environment o) {
  ...
  if (buildCounterEnvironment < 3) {
    ...
    checkUnnamed4352(o.experiments);
    checkUnnamed4353(o.internalExperiments);
    checkUnnamed4354(o.sdkPipelineOptions);
    unittest.expect(o.serviceAccountEmail, unittest.equals('foo'));
    unittest.expect(o.tempStoragePrefix, unittest.equals('foo'));
    checkUnnamed4355(o.userAgent);
    checkUnnamed4356(o.version);
    checkUnnamed4357(o.workerPools);
  }
  buildCounterEnvironment--;
}
...
checkUnnamed4358(core.List<api.ComponentSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4359(core.List<api.ComponentTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4360(core.List<api.StageSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4361(core.List<api.StageSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStageSource(o[0]);
  checkStageSource(o[1]);
}
...
buildExecutionStageSummary() {
  ...
  if (buildCounterExecutionStageSummary < 3) {
    o.componentSource = buildUnnamed4358();
    o.componentTransform = buildUnnamed4359();
    o.id = "foo";
    o.inputSource = buildUnnamed4360();
    o.kind = "foo";
    o.name = "foo";
    o.outputSource = buildUnnamed4361();
  }
  buildCounterExecutionStageSummary--;
  return o;
}
...
checkExecutionStageSummary(api.ExecutionStageSummary o) {
  buildCounterExecutionStageSummary++;
  if (buildCounterExecutionStageSummary < 3) {
    checkUnnamed4358(o.componentSource);
    checkUnnamed4359(o.componentTransform);
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed4360(o.inputSource);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4361(o.outputSource);
  }
  buildCounterExecutionStageSummary--;
}
...
checkUnnamed4362(core.List<api.InstructionInput> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildHistogram() {
  ...
  if (buildCounterHistogram < 3) {
    o.bucketCounts = buildUnnamed4364();
...
checkHistogram(api.Histogram o) {
  buildCounterHistogram++;
  if (buildCounterHistogram < 3) {
    checkUnnamed4364(o.bucketCounts);
...
checkUnnamed4365(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4366(core.List<api.SplitInt64> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSplitInt64(o[0]);
  checkSplitInt64(o[1]);
}
...
checkUnnamed4368(core.List<api.ExecutionStageState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4369(core.List<api.Step> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStep(o[0]);
  checkStep(o[1]);
}
...
checkUnnamed4371(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildJob() {
  ...
  if (buildCounterJob < 3) {
    ...
    o.stageStates = buildUnnamed4368();
    o.steps = buildUnnamed4369();
    o.tempFiles = buildUnnamed4370();
    o.transformNameMapping = buildUnnamed4371();
    o.type = "foo";
  }
  buildCounterJob--;
  return o;
...
checkJob(api.Job o) {
  ...
  if (buildCounterJob < 3) {
    ...
    checkUnnamed4368(o.stageStates);
    checkUnnamed4369(o.steps);
    checkUnnamed4370(o.tempFiles);
    checkUnnamed4371(o.transformNameMapping);
...
checkUnnamed4372(core.Map<core.String, api.JobExecutionStageInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4374(core.List<api.MetricUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLeaseWorkItemRequest() {
  ...
  if (buildCounterLeaseWorkItemRequest < 3) {
    ...
    o.workItemTypes = buildUnnamed4376();
    o.workerCapabilities = buildUnnamed4377();
    o.workerId = "foo";
  }
  buildCounterLeaseWorkItemRequest--;
  return o;
...
checkLeaseWorkItemRequest(api.LeaseWorkItemRequest o) {
  ...
  if (buildCounterLeaseWorkItemRequest < 3) {
    ...
    checkUnnamed4376(o.workItemTypes);
    checkUnnamed4377(o.workerCapabilities);
    unittest.expect(o.workerId, unittest.equals('foo'));
  }
  buildCounterLeaseWorkItemRequest--;
}
...
checkUnnamed4378(core.List<api.WorkItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkItem(o[0]);
  checkWorkItem(o[1]);
}
...
checkUnnamed4379(core.List<api.AutoscalingEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4380(core.List<api.JobMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJobMessage(o[0]);
  checkJobMessage(o[1]);
}
...
buildListJobMessagesResponse() {
  ...
  if (buildCounterListJobMessagesResponse < 3) {
    o.autoscalingEvents = buildUnnamed4379();
    o.jobMessages = buildUnnamed4380();
    o.nextPageToken = "foo";
  }
  buildCounterListJobMessagesResponse--;
  return o;
...
checkListJobMessagesResponse(api.ListJobMessagesResponse o) {
  buildCounterListJobMessagesResponse++;
  if (buildCounterListJobMessagesResponse < 3) {
    checkUnnamed4379(o.autoscalingEvents);
    checkUnnamed4380(o.jobMessages);
...
checkUnnamed4381(core.List<api.FailedLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4382(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
buildListJobsResponse() {
  ...
  if (buildCounterListJobsResponse < 3) {
    o.failedLocation = buildUnnamed4381();
    o.jobs = buildUnnamed4382();
    o.nextPageToken = "foo";
  }
  buildCounterListJobsResponse--;
  return o;
...
checkListJobsResponse(api.ListJobsResponse o) {
  buildCounterListJobsResponse++;
  if (buildCounterListJobsResponse < 3) {
    checkUnnamed4381(o.failedLocation);
    checkUnnamed4382(o.jobs);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListJobsResponse--;
}
...
checkUnnamed4383(core.List<api.ParallelInstruction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMapTask() {
  ...
  if (buildCounterMapTask < 3) {
    o.instructions = buildUnnamed4383();
    o.stageName = "foo";
    o.systemName = "foo";
  }
  buildCounterMapTask--;
...
checkMapTask(api.MapTask o) {
  buildCounterMapTask++;
  if (buildCounterMapTask < 3) {
    checkUnnamed4383(o.instructions);
...
checkUnnamed4384(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4385(core.List<api.MultiOutputInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4386(core.List<api.SideInputInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildParDoInstruction() {
  ...
  if (buildCounterParDoInstruction < 3) {
    ...
    o.multiOutputInfos = buildUnnamed4385();
    o.numOutputs = 42;
    o.sideInputs = buildUnnamed4386();
    o.userFn = buildUnnamed4387();
  }
  buildCounterParDoInstruction--;
  return o;
}
...
checkParDoInstruction(api.ParDoInstruction o) {
  ...
  if (buildCounterParDoInstruction < 3) {
    ...
    checkUnnamed4385(o.multiOutputInfos);
    unittest.expect(o.numOutputs, unittest.equals(42));
    checkUnnamed4386(o.sideInputs);
    checkUnnamed4387(o.userFn);
  }
  buildCounterParDoInstruction--;
}
...
checkUnnamed4388(core.List<api.InstructionOutput> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4390(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4391(core.List<api.SideInputInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSideInputInfo(o[0]);
  checkSideInputInfo(o[1]);
}
...
buildPartialGroupByKeyInstruction() {
  ...
  if (buildCounterPartialGroupByKeyInstruction < 3) {
    o.input = buildInstructionInput();
    o.inputElementCodec = buildUnnamed4390();
    o.originalCombineValuesInputStoreName = "foo";
    o.originalCombineValuesStepName = "foo";
    o.sideInputs = buildUnnamed4391();
    o.valueCombiningFn = buildUnnamed4392();
  }
  buildCounterPartialGroupByKeyInstruction--;
  return o;
}
...
checkPartialGroupByKeyInstruction(api.PartialGroupByKeyInstruction o) {
  ...
  if (buildCounterPartialGroupByKeyInstruction < 3) {
    checkInstructionInput(o.input);
    checkUnnamed4390(o.inputElementCodec);
    unittest.expect(
    ...
    checkUnnamed4391(o.sideInputs);
    checkUnnamed4392(o.valueCombiningFn);
  }
  buildCounterPartialGroupByKeyInstruction--;
}
...
checkUnnamed4393(core.List<api.DisplayData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4394(core.List<api.ExecutionStageSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4395(core.List<api.TransformSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPipelineDescription() {
  ...
  if (buildCounterPipelineDescription < 3) {
    o.displayData = buildUnnamed4393();
    o.executionPipelineStage = buildUnnamed4394();
    o.originalPipelineTransform = buildUnnamed4395();
  }
  buildCounterPipelineDescription--;
  return o;
}
...
checkPipelineDescription(api.PipelineDescription o) {
  buildCounterPipelineDescription++;
  if (buildCounterPipelineDescription < 3) {
    checkUnnamed4393(o.displayData);
    checkUnnamed4394(o.executionPipelineStage);
    checkUnnamed4395(o.originalPipelineTransform);
  }
  buildCounterPipelineDescription--;
}
...
checkUnnamed4396(core.List<api.WorkItemStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReportWorkItemStatusRequest() {
  ...
  if (buildCounterReportWorkItemStatusRequest < 3) {
    o.currentWorkerTime = "foo";
    o.location = "foo";
    o.workItemStatuses = buildUnnamed4396();
    o.workerId = "foo";
  }
  buildCounterReportWorkItemStatusRequest--;
  return o;
...
checkReportWorkItemStatusRequest(api.ReportWorkItemStatusRequest o) {
  ...
  if (buildCounterReportWorkItemStatusRequest < 3) {
    unittest.expect(o.currentWorkerTime, unittest.equals('foo'));
    unittest.expect(o.location, unittest.equals('foo'));
    checkUnnamed4396(o.workItemStatuses);
    unittest.expect(o.workerId, unittest.equals('foo'));
  }
  buildCounterReportWorkItemStatusRequest--;
}
...
checkUnnamed4397(core.List<api.WorkItemServiceState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReportWorkItemStatusResponse() {
  ...
  if (buildCounterReportWorkItemStatusResponse < 3) {
    o.workItemServiceStates = buildUnnamed4397();
  }
  buildCounterReportWorkItemStatusResponse--;
  return o;
}
...
checkReportWorkItemStatusResponse(api.ReportWorkItemStatusResponse o) {
  buildCounterReportWorkItemStatusResponse++;
  if (buildCounterReportWorkItemStatusResponse < 3) {
    checkUnnamed4397(o.workItemServiceStates);
  }
  buildCounterReportWorkItemStatusResponse--;
}
...
checkUnnamed4398(core.List<api.CPUTime> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCPUTime(o[0]);
  checkCPUTime(o[1]);
}
...
buildRuntimeEnvironment() {
  ...
  if (buildCounterRuntimeEnvironment < 3) {
    o.additionalExperiments = buildUnnamed4399();
...
checkRuntimeEnvironment(api.RuntimeEnvironment o) {
  buildCounterRuntimeEnvironment++;
  if (buildCounterRuntimeEnvironment < 3) {
    checkUnnamed4399(o.additionalExperiments);
...
checkUnnamed4400(core.List<api.WorkerMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSendWorkerMessagesRequest() {
  ...
  if (buildCounterSendWorkerMessagesRequest < 3) {
    o.location = "foo";
    o.workerMessages = buildUnnamed4400();
  }
  buildCounterSendWorkerMessagesRequest--;
  return o;
}
...
checkSendWorkerMessagesRequest(api.SendWorkerMessagesRequest o) {
  ...
  if (buildCounterSendWorkerMessagesRequest < 3) {
    unittest.expect(o.location, unittest.equals('foo'));
    checkUnnamed4400(o.workerMessages);
  }
  buildCounterSendWorkerMessagesRequest--;
}
...
checkUnnamed4401(core.List<api.WorkerMessageResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSendWorkerMessagesResponse() {
  ...
  if (buildCounterSendWorkerMessagesResponse < 3) {
    o.workerMessageResponses = buildUnnamed4401();
  }
  buildCounterSendWorkerMessagesResponse--;
  return o;
}
...
checkSendWorkerMessagesResponse(api.SendWorkerMessagesResponse o) {
  buildCounterSendWorkerMessagesResponse++;
  if (buildCounterSendWorkerMessagesResponse < 3) {
    checkUnnamed4401(o.workerMessageResponses);
  }
  buildCounterSendWorkerMessagesResponse--;
}
...
checkUnnamed4402(core.List<api.SideInputInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSideInputInfo(o[0]);
  checkSideInputInfo(o[1]);
}
...
checkUnnamed4403(core.List<api.SeqMapTaskOutputInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSeqMapTask() {
  ...
  if (buildCounterSeqMapTask < 3) {
    o.inputs = buildUnnamed4402();
    o.name = "foo";
    o.outputInfos = buildUnnamed4403();
    o.stageName = "foo";
    o.systemName = "foo";
    o.userFn = buildUnnamed4404();
  }
  buildCounterSeqMapTask--;
  return o;
}
...
checkSeqMapTask(api.SeqMapTask o) {
  buildCounterSeqMapTask++;
  if (buildCounterSeqMapTask < 3) {
    checkUnnamed4402(o.inputs);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4403(o.outputInfos);
    unittest.expect(o.stageName, unittest.equals('foo'));
    unittest.expect(o.systemName, unittest.equals('foo'));
    checkUnnamed4404(o.userFn);
  }
  buildCounterSeqMapTask--;
}
...
checkUnnamed4406(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
buildSideInputInfo() {
  ...
  if (buildCounterSideInputInfo < 3) {
    o.kind = buildUnnamed4405();
    o.sources = buildUnnamed4406();
    o.tag = "foo";
  }
  buildCounterSideInputInfo--;
  return o;
...
checkSideInputInfo(api.SideInputInfo o) {
  buildCounterSideInputInfo++;
  if (buildCounterSideInputInfo < 3) {
    checkUnnamed4405(o.kind);
    checkUnnamed4406(o.sources);
    unittest.expect(o.tag, unittest.equals('foo'));
  }
  buildCounterSideInputInfo--;
}
...
checkUnnamed4407(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSink() {
  ...
  if (buildCounterSink < 3) {
    o.codec = buildUnnamed4407();
    o.spec = buildUnnamed4408();
  }
  buildCounterSink--;
  return o;
}
...
checkSink(api.Sink o) {
  buildCounterSink++;
  if (buildCounterSink < 3) {
    checkUnnamed4407(o.codec);
    checkUnnamed4408(o.spec);
  }
  buildCounterSink--;
}
...
buildUnnamed4410() {
  ...
  o.add(buildUnnamed4409());
  o.add(buildUnnamed4409());
  return o;
}

checkUnnamed4410(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4409(o[0]);
  checkUnnamed4409(o[1]);
}
...
checkUnnamed4411(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSource() {
  ...
  if (buildCounterSource < 3) {
    o.baseSpecs = buildUnnamed4410();
    o.codec = buildUnnamed4411();
    o.doesNotNeedSplitting = true;
    o.metadata = buildSourceMetadata();
    o.spec = buildUnnamed4412();
  }
  buildCounterSource--;
  return o;
}
...
checkUnnamed4413(core.List<api.DerivedSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4414(core.List<api.SourceSplitShard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSourceSplitResponse() {
  ...
  if (buildCounterSourceSplitResponse < 3) {
    o.bundles = buildUnnamed4413();
    o.outcome = "foo";
    o.shards = buildUnnamed4414();
  }
  buildCounterSourceSplitResponse--;
  return o;
}
...
checkSourceSplitResponse(api.SourceSplitResponse o) {
  buildCounterSourceSplitResponse++;
  if (buildCounterSourceSplitResponse < 3) {
    checkUnnamed4413(o.bundles);
    unittest.expect(o.outcome, unittest.equals('foo'));
    checkUnnamed4414(o.shards);
  }
  buildCounterSourceSplitResponse--;
}
...
buildUnnamed4416() {
  var o = new core.List<core.Map<core.String, core.Object>>();
  o.add(buildUnnamed4415());
  o.add(buildUnnamed4415());
  return o;
}

checkUnnamed4416(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4415(o[0]);
  checkUnnamed4415(o[1]);
}
...
checkUnnamed4418(core.List<api.ParallelInstruction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParallelInstruction(o[0]);
  checkParallelInstruction(o[1]);
}
...
buildStreamingComputationConfig() {
  ...
  if (buildCounterStreamingComputationConfig < 3) {
    o.computationId = "foo";
    o.instructions = buildUnnamed4418();
    o.stageName = "foo";
    o.systemName = "foo";
  }
  buildCounterStreamingComputationConfig--;
...
checkStreamingComputationConfig(api.StreamingComputationConfig o) {
  ...
  if (buildCounterStreamingComputationConfig < 3) {
    unittest.expect(o.computationId, unittest.equals('foo'));
    checkUnnamed4418(o.instructions);
    unittest.expect(o.stageName, unittest.equals('foo'));
    unittest.expect(o.systemName, unittest.equals('foo'));
  }
  buildCounterStreamingComputationConfig--;
...
checkUnnamed4419(core.List<api.KeyRangeDataDiskAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStreamingComputationRanges() {
  ...
  if (buildCounterStreamingComputationRanges < 3) {
    o.computationId = "foo";
    o.rangeAssignments = buildUnnamed4419();
  }
  buildCounterStreamingComputationRanges--;
  return o;
}
...
checkStreamingComputationRanges(api.StreamingComputationRanges o) {
  ...
  if (buildCounterStreamingComputationRanges < 3) {
    unittest.expect(o.computationId, unittest.equals('foo'));
    checkUnnamed4419(o.rangeAssignments);
  }
  buildCounterStreamingComputationRanges--;
}
...
checkUnnamed4420(core.List<api.StreamingComputationRanges> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4421(core.List<api.MountedDataDisk> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStreamingComputationTask() {
  ...
  if (buildCounterStreamingComputationTask < 3) {
    o.computationRanges = buildUnnamed4420();
    o.dataDisks = buildUnnamed4421();
    o.taskType = "foo";
  }
  buildCounterStreamingComputationTask--;
  return o;
...
checkStreamingComputationTask(api.StreamingComputationTask o) {
  buildCounterStreamingComputationTask++;
  if (buildCounterStreamingComputationTask < 3) {
    checkUnnamed4420(o.computationRanges);
    checkUnnamed4421(o.dataDisks);
...
checkUnnamed4422(core.List<api.StreamingComputationConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4423(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildStreamingConfigTask() {
  ...
  if (buildCounterStreamingConfigTask < 3) {
    o.streamingComputationConfigs = buildUnnamed4422();
    o.userStepToStateFamilyNameMap = buildUnnamed4423();
...
checkStreamingConfigTask(api.StreamingConfigTask o) {
  buildCounterStreamingConfigTask++;
  if (buildCounterStreamingConfigTask < 3) {
    checkUnnamed4422(o.streamingComputationConfigs);
    checkUnnamed4423(o.userStepToStateFamilyNameMap);
...
checkUnnamed4425(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}
...
buildTaskRunnerSettings() {
  ...
  if (buildCounterTaskRunnerSettings < 3) {
    ...
    o.oauthScopes = buildUnnamed4426();
...
checkTaskRunnerSettings(api.TaskRunnerSettings o) {
  ...
  if (buildCounterTaskRunnerSettings < 3) {
    ...
    checkUnnamed4426(o.oauthScopes);
...
checkUnnamed4427(core.List<api.ParameterMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4428(core.List<api.ComputationTopology> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4429(core.List<api.DataDiskAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4430(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildTopologyConfig() {
  ...
  if (buildCounterTopologyConfig < 3) {
    o.computations = buildUnnamed4428();
    o.dataDiskAssignments = buildUnnamed4429();
    o.forwardingKeyBits = 42;
    o.persistentStateVersion = 42;
    o.userStageToComputationNameMap = buildUnnamed4430();
  }
  buildCounterTopologyConfig--;
  return o;
}
...
checkTopologyConfig(api.TopologyConfig o) {
  buildCounterTopologyConfig++;
  if (buildCounterTopologyConfig < 3) {
    checkUnnamed4428(o.computations);
    checkUnnamed4429(o.dataDiskAssignments);
    unittest.expect(o.forwardingKeyBits, unittest.equals(42));
    unittest.expect(o.persistentStateVersion, unittest.equals(42));
    checkUnnamed4430(o.userStageToComputationNameMap);
  }
  buildCounterTopologyConfig--;
}
...
checkUnnamed4431(core.List<api.DisplayData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDisplayData(o[0]);
  checkDisplayData(o[1]);
}
...
buildTransformSummary() {
  ...
  if (buildCounterTransformSummary < 3) {
    o.displayData = buildUnnamed4431();
    o.id = "foo";
    o.inputCollectionName = buildUnnamed4432();
    o.kind = "foo";
    o.name = "foo";
    o.outputCollectionName = buildUnnamed4433();
  }
  buildCounterTransformSummary--;
  return o;
}
...
checkTransformSummary(api.TransformSummary o) {
  buildCounterTransformSummary++;
  if (buildCounterTransformSummary < 3) {
    checkUnnamed4431(o.displayData);
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed4432(o.inputCollectionName);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4433(o.outputCollectionName);
  }
  buildCounterTransformSummary--;
}
...
checkUnnamed4434(core.List<api.Package> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackage(o[0]);
  checkPackage(o[1]);
}
...
checkUnnamed4435(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4436(core.List<api.MetricShortId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildWorkItemServiceState() {
  ...
  if (buildCounterWorkItemServiceState < 3) {
    o.harnessData = buildUnnamed4435();
    o.leaseExpireTime = "foo";
    o.metricShortId = buildUnnamed4436();
...
checkWorkItemServiceState(api.WorkItemServiceState o) {
  buildCounterWorkItemServiceState++;
  if (buildCounterWorkItemServiceState < 3) {
    checkUnnamed4435(o.harnessData);
    unittest.expect(o.leaseExpireTime, unittest.equals('foo'));
    checkUnnamed4436(o.metricShortId);
...
checkUnnamed4437(core.List<api.CounterUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4438(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}
...
checkUnnamed4439(core.List<api.MetricUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricUpdate(o[0]);
  checkMetricUpdate(o[1]);
}
...
buildWorkItemStatus() {
  ...
  if (buildCounterWorkItemStatus < 3) {
    o.completed = true;
    o.counterUpdates = buildUnnamed4437();
    o.dynamicSourceSplit = buildDynamicSourceSplit();
    o.errors = buildUnnamed4438();
    o.metricUpdates = buildUnnamed4439();
...
checkWorkItemStatus(api.WorkItemStatus o) {
  ...
  if (buildCounterWorkItemStatus < 3) {
    ...
    checkUnnamed4437(o.counterUpdates);
    checkDynamicSourceSplit(o.dynamicSourceSplit);
    checkUnnamed4438(o.errors);
    checkUnnamed4439(o.metricUpdates);
...
checkUnnamed4441(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4442(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4444(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4445(core.List<api.Disk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDisk(o[0]);
  checkDisk(o[1]);
}
...
checkUnnamed4446(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4447(core.List<api.Package> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackage(o[0]);
  checkPackage(o[1]);
}
...
checkUnnamed4448(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildWorkerPool() {
  ...
  if (buildCounterWorkerPool < 3) {
    ...
    o.kind = "foo";
    o.machineType = "foo";
    o.metadata = buildUnnamed4446();
    o.network = "foo";
    o.numThreadsPerWorker = 42;
    o.numWorkers = 42;
    o.onHostMaintenance = "foo";
    o.packages = buildUnnamed4447();
    o.poolArgs = buildUnnamed4448();
    o.subnetwork = "foo";
...
checkWorkerPool(api.WorkerPool o) {
  ...
  if (buildCounterWorkerPool < 3) {
    ...
    checkUnnamed4447(o.packages);
    checkUnnamed4448(o.poolArgs);
